...
---
# Why do ~~vrsion~~ version control?

.pull-left[
<br>
1. Revert back to previous version of a file

2. Keep a history of changes made to your work

3. **Collaborate** on your work simultaneously while managing conflicts
]
...
There are a number of different software available that can help with version control. You might have heard of a few, two of the most well-known are Apache Subversion (SVN) and Git. Because R users have generally adopted GitHub for package development, we will focus on Git today.
...
1. First, you create some work locally in your project directory. 
2. If you want to start a version history of these edits, the first step is to "stage" the changes. The shell command is **git add**.
